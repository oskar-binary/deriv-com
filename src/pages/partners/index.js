...
const Partners = () => {
    return (
        <Layout nav_type="partners">
            <SectionContainer>
                <Container direction="column">
                    <Header as="h4" weight="500" align="center">
                        {localize(
                            'Earn up to 45% lifetime commission with an online trading provider that enables anyone to trade on any financial market with the utmost convenience. Binary Group –– the owner of Binary.com and Deriv –– has a proven track record of running successful referral programmes with prompt payouts.',
                        )}
                    </Header>
